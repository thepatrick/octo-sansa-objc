...
// octo-sansa
#define COCOAPODS_POD_AVAILABLE_octo_sansa
#define COCOAPODS_VERSION_MAJOR_octo_sansa 0
#define COCOAPODS_VERSION_MINOR_octo_sansa 1
#define COCOAPODS_VERSION_PATCH_octo_sansa 0
